                       ...
                       ?>
                         <a href="<?php echo SITEURL;?>category-plant.php?category_id=<?php echo $id;?>">
                            <div class="box-3 float-container">
                                ...
                                //Check wthether image is available or not
                                if($image_name=="")
                                {
                                    //Display message
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php
               ...
               //Getting Foods from Database that are active and feartured
               //SQL QUERy
                             ...
                             <?php
                                 ...
                                 else
                                 {
                                     ...
                                     ?>
                                      ...
                                      <img src="<?php echo SITEURL;?>images/plant/<?php echo $image_name;?>" alt="Chicke Hawain Pizza" class="img-responsive img-curve">
                                     <?php
                                 }
